...
public class CarInfoActivity extends AppCompatActivity {
    ...
    private List<Contact> carImageList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carInfoScrollView = findViewById(R.id.carInfoScrollView);
                        ...
                        try {
                            ...
                            if (status.equals("success")) {
                                ...
                                for (int i = 0; i < jsonImageArray.length(); i++) {
                                    ...
                                    carImageList.add(new Contact(images.getString("imageurl"), String.valueOf(i)));
                                }
                                updateSlider();
                            }
    ...
    private void initializeSlider(){
        ...
        view.setImageDrawable(R.drawable.image_loading)
            .setDescription("Images are loading...");
        flipperLayout.addFlipperView(view);*/
    }

    private void updateSlider(){
        //flipperLayout.removeAllViews();
        carInfoScrollView.smoothScrollTo(0,0);
        for (int i = 0; i < carImageList.size(); i++) {
            Log.d("databaseList", "onCreate: " + carImageList.get(i).getID() +  " "+ carImageList.get(i).getName());
            FlipperView view = new FlipperView(getBaseContext());
            view.setImageUrl(carImageList.get(i).getName().toString())
                    .setDescription("");
            flipperLayout.addFlipperView(view);
            view.setOnFlipperClickListener(new FlipperView.OnFlipperClickListener() {
                ...
                public void onFlipperClick(FlipperView flipperView) {
                    ...
                    i.putExtra("url", String.valueOf(carImageList.get(flipperLayout.getCurrentPagePosition()).getName().toString()));
                    startActivity(i);
                }
            });
        }
    ...
    private void showProgressDialog(){
        if(webLoadingProgressBar != null && !webLoadingProgressBar.isShowing()){
