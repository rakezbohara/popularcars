...
public class FeaturedListActivity extends AppCompatActivity {
...
//        setTitle("Featured Cars");
        ...
        getSupportActionBar().setTitle("Featured Cars");

//        topToolBar.setLogo(R.drawable.logo);
//        topToolBar.setLogoDescription(getResources().getString(R.string.logo_desc));

        rowListItem = new ArrayList<>();
        lLayout = new LinearLayoutManager(FeaturedListActivity.this);

        RecyclerView rView = (RecyclerView)findViewById(R.id.featuredCarsRecycleView);
        rView.setLayoutManager(lLayout);

        final RecyclerViewAdapter rcAdapter = new RecyclerViewAdapter(FeaturedListActivity.this, rowListItem);
