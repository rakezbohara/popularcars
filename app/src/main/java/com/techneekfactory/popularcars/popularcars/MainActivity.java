...
//                fBundle.putString("URL", "http://popularcarsoman.dev.techneek.in/app_page_dynamic.php?pid=1");
                fBundle.putString("URL", URLEndpoints.GateWayBaseURL+"/app_page_inHouseFinance.php");
...
//                fBundle.putString("URL", "http://popularcarsoman.dev.techneek.in/app_page_dynamic.php?pid=1");
                gBundle.putString("URL", URLEndpoints.GateWayBaseURL+"/app_page_buyers_guide.php?slug=tips-for-buying");
...
//                fBundle.putString("URL", "http://popularcarsoman.dev.techneek.in/app_page_dynamic.php?pid=1");
                hBundle.putString("URL", URLEndpoints.GateWayBaseURL+"/app_page_buyers_guide.php?slug=inspection");
...
//                fBundle.putString("URL", "http://popularcarsoman.dev.techneek.in/app_page_dynamic.php?pid=1");
                iBundle.putString("URL", URLEndpoints.GateWayBaseURL+"/app_page_buyers_guide.php?slug=test-drive");
...
//                fBundle.putString("URL", "http://popularcarsoman.dev.techneek.in/app_page_dynamic.php?pid=1");
                jBundle.putString("URL", URLEndpoints.GateWayBaseURL+"/app_page_buyers_guide.php?slug=close-the-deal");
